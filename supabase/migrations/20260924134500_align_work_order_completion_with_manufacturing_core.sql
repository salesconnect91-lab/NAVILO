...
begin
 ...
 update public.work_orders set status='completed',qty=v_accepted,end_date=coalesce(end_date,current_date) where id=v_order.id and user_id=v_user_id and company_id=v_company_id;
end $$;