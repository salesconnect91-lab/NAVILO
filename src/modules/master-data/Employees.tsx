...
export default function Employees() {
  ...
  return <div className="space-y-4" data-navilo-master-standard="true">
    ...
    <div className="mt-4"><DataTable<Employee> loading={loading} rows={filtered} emptyMessage="No employees found." columns={[
      ...
      {key:"is_active",label:"Status",render:e=><button type="button" className="btn" onClick={()=>void toggle(e)}>{e.is_active?"Active":"Inactive"}</button>},
      {key:"actions",label:"Actions",sortable:false,render:e=><button className="btn" title="Edit" onClick={()=>openEdit(e)}><Pencil className="h-4 w-4" /></button>}
