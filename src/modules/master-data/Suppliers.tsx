...
export default function Suppliers() {
  ...
  return <div className="space-y-4" data-navilo-master-standard="true">
    ...
    <div data-report-content data-navilo-customizable="true" className="contents"><DataTable columns={columns} rows={rows} loading={loading} emptyMessage="No suppliers yet." /></div>
