...
export default function Suppliers() {
  ...
  const handleImport = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      await fetchRows();
      alert(`${imported.length} suppliers imported successfully.`);
    } catch (err) {
  ...
  return <div className="space-y-4" data-navilo-master-standard="true">
    <PageHeader title="Suppliers" subtitle="Vendor accounts" action={<div className="flex flex-wrap items-center gap-2">{canCreate&&<button onClick={openCreate} className="btn-primary">+ New Supplier</button>}</div>} />
