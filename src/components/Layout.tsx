...
const navigation:NavNode[]=[
  ...
  {key:"sales",label:"Sales / سیلز",icon:Lucide.ShoppingCart,module:"sales",children:[{key:"sales-invoice-group",label:"Invoices / انوائسز",module:"sales",children:[{key:"sales-invoices",to:"/sales",label:"Sales Invoices / سیلز انوائسز",end:true,module:"sales"},{key:"sales-consolidated",to:"/sales/consolidated",label:"Consolidated Invoices / مشترکہ انوائسز",module:"sales",steelOnly:true}]},{key:"sales-workflow",to:"/sales/workflow",label:"Quotation to Dispatch / کوٹیشن تا ڈسپیچ",module:"sales"},{key:"sales-order-book",to:"/sales/order-book",label:"Sales Order Book / سیلز آرڈر بک",module:"sales"}]},
  {key:"purchase",label:"Purchase / خریداری",icon:Lucide.Truck,module:"purchase",children:[{key:"purchase-invoice-group",label:"Invoices / انوائسز",module:"purchase",children:[{key:"purchase-invoices",to:"/purchase",label:"Purchase Invoices / خریداری انوائسز",end:true,module:"purchase"},{key:"purchase-consolidated",to:"/purchase/consolidated",label:"Consolidated Purchase / مشترکہ خریداری",module:"purchase"}]},{key:"purchase-workflow",to:"/purchase/workflow",label:"Requisition to GRN / ریکوزیشن تا وصولی",module:"purchase"},{key:"purchase-order-book",to:"/purchase/order-book",label:"Purchase Order Book / پرچیز آرڈر بک",module:"purchase"}]},
  ...
  {key:"transport",label:"Transport / ٹرانسپورٹ",to:"/transport",icon:Lucide.BusFront,module:"transport"},
...
export default function Layout({children}:{children:ReactNode}){
  ...
  useEffect(()=>{
    ...
    const closeOnEscape=(event:KeyboardEvent)=>{if(event.key==="Escape"){setMobileOpen(false);mobileMenuButton.current?.focus();}};
